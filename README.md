...
### English answer with legal citations

The assistant answers an English question about prohibited AI practices while
grounding each claim in the relevant AI Act article or recital.

![English AI Act answer generated by the multilingual legal RAG assistant](docs/images/app-english-answer.png)

<details>
<summary><strong>View the retrieved AI Act sources</strong></summary>

The source panel preserves article and recital references, document links, page
ranges, source-language badges, and a per-stage latency breakdown.

![English AI Act article-level and recital-level citations](docs/images/app-english-citations.png)

</details>

### Cross-lingual retrieval: Ukrainian question, English law

A Ukrainian question about Article 16 of the Digital Services Act is answered
in Ukrainian even though the supporting statute is indexed in English.

![Ukrainian answer grounded in the English Digital Services Act](docs/images/app-cross-lingual-dsa-answer.png)

<details>
<summary><strong>View the cross-lingual DSA sources</strong></summary>

The retrieved evidence comes from the English DSA and retains its original
article, recital, page, and language metadata.

![English DSA sources retrieved for a Ukrainian question](docs/images/app-cross-lingual-dsa-sources.png)

</details>

### Polish GDPR answer

For a Polish question about Article 83, the assistant distinguishes both GDPR
fine tiers—EUR 10 million or 2% of worldwide turnover, and EUR 20 million or
4%—and cites the official Polish text.

![Polish answer explaining the two GDPR fine tiers](docs/images/app-polish-gdpr-answer.png)

<details>
<summary><strong>View the Polish GDPR sources</strong></summary>

![Polish GDPR article-level citations](docs/images/app-polish-gdpr-citations.png)
